...
public class CustomerListGridAdapter extends BaseAdapter {
    ...
    public CustomerListGridAdapter(Context mcontext, List<AddCustomerDetail> productname) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        // TODO Auto-generated method stub
        final CustomerListGridAdapter.Holder holder=new CustomerListGridAdapter.Holder();
        View rowView;

        rowView = inflater.inflate(R.layout.customer_gridlayout, null);

        holder.txt_username=(TextView) rowView.findViewById(R.id.txt_custname);
